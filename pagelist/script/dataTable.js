define([
    'jquery', 'pager', 'template'
], function ($, pager, template) {

    var DataTable = function (element, options) {
        this.$element = element;
        this.options = $.extend({}, DataTable.DEFAULTS, options);
        this.render = template.compile(this.options.template);
        this.currentPage = 1;
        this.init();
    };
    ...
    $.extend(DataTable.prototype, {
        ...
        renderBody: function (data) {
            ...
            var _html = self.render(data);

            this.$bodyContainer.empty().html(_html);
        },
        //渲染分页器
